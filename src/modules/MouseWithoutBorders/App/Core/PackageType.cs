...
internal enum PackageType // : int
{
    ...
    // Enhanced SMB drag metadata. These packets contain manifest chunks only;
    // file contents remain on the existing SMB shares.
    EnhancedDragManifestChunk = 80,
    EnhancedDragCancel = 81,
    EnhancedDragDrop = 82,
